...
TICKERS = [
    ...
    "SUIUSDT", "SUSDT", "TAOUSDT", "THETAUSDT", "TONUSDT", "UNIUSDT", "XRPUSDT",
]
...
# Timeframes for candle pattern alerts (Doji, Tweezer Top/Bottom): skip 1h and 1w, too noisy
CANDLE_PATTERN_TIMEFRAMES = ["4h", "1d", "1M"]
